...
var Usermodel = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Couldn't get users because of ".concat(error_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT id,first_name,last_name,user_name FROM users WHERE id =($1)';
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("Couldn't get user with this id : ".concat(id, "=> ").concat(error_2.message));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("Couldn't add new user => ".concat(error_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    Usermodel.prototype.update = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        throw new Error("Could not update user: ".concat(u.user_name, ", ").concat(error_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    Usermodel.prototype.authenticate = function (user_name, password) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, sql, result, hashPassword_1, isPasswordValid, userInfo, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 2:
                        ...
                        isPasswordValid = bcrypt_1.default.compareSync("".concat(password).concat(config_1.default.pepper), hashPassword_1);
                        if (!isPasswordValid) return [3 /*break*/, 4];
                        return [4 /*yield*/, connection.query('SELECT id, user_name, first_name, last_name FROM users WHERE user_name=($1)', [user_name])];
                    case 3:
                        userInfo = _a.sent();
                    ...
                    case 5:
                        error_5 = _a.sent();
                        throw new Error("Unable to login: ".concat(error_5));
