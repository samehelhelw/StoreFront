...
exports.authenticate = exports.update = exports.show = exports.index = exports.create = void 0;
...
var index = function (_, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userr, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var authenticate = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, user_name, password, userr, token, err_5;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, user_name = _a.user_name, password = _a.password;
                return [4 /*yield*/, user.authenticate(user_name, password)];
            case 1:
                userr = _b.sent();
                token = jsonwebtoken_1.default.sign({ userr: userr }, config_1.default.tokenSecret);
                if (!user) {
                ...
                return [2 /*return*/, res.json({
                        status: 'success',
                        data: __assign(__assign({}, userr), { token: token }),
