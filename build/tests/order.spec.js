...
describe('orderModel Test', function () {
    describe(' Test  Exsist', function () {
        ...
        it('==> Should get product in order .', function () {
...
describe('Create Order Test ', function () {
    ...
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        var createdProduct, createdOrder, createdUser;
    ...
    afterAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        var connection, sql, sqll, res, ress;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.default.connect()];
                case 1:
                    connection = _a.sent();
                    sql = "DELETE FROM orders where user_id = '".concat(order.user_id, "';");
                    sqll = "DELETE FROM users where user_name = '".concat(user.user_name, "'");
                    return [4 /*yield*/, connection.query(sql)];
                case 2:
                    res = _a.sent();
                    return [4 /*yield*/, connection.query(sqll)];
                case 3:
                    ress = _a.sent();
                    connection.release();
                    return [2 /*return*/];
    ...
    it(' return  order', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
